...
class ReportTypeView extends StatefulWidget {
  ...
  ReportTypeView({Key? key, required this.selectedReport, required this.reportTypes, required this.next, required this.changeSelectedReport}) : super(key: key);
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: widget.reportTypes.map((e) => _buildReportItem(text: e.text, value: int.parse(e.code))).toList(),
                  ),
                ),
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: isActive ? () => widget.next(widget.selectedReport) : null,
                    child: Text(
                      '下一步',
                      style: TextStyle(color: isActive ? Colors.white : Colors.white.withOpacity(0.5), fontSize: 16.sp),
                    ),
                  ),
                ),
              ],
