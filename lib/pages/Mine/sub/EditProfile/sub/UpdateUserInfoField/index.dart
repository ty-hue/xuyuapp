...
class UpdateUserInfoFieldPage extends StatefulWidget {
  ...
  UpdateUserInfoFieldPage({Key? key, required this.extra}) : super(key: key);
    ...
    return WithStatusbarColorView(
      ...
      child: Scaffold(
        appBar: StaticAppBar(
          ...
          title: '修改${widget.extra.title}',
          titleFontWeight: FontWeight.bold,
          leadingChild: AppBarTextBtn(
            text: '取消',
            onTap: () {
              context.pop();
            },
              ...
              Form(
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    label: Text(
                      widget.extra.title == '简介'
                          ? ''
                          : '你的${widget.extra.title}',
                      style: TextStyle(
